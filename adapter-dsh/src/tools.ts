...
export function registerNovelTools(
  ...
  ctx.tools.register(defineTool({
    ...
    output: envelopeOutput,
    timeoutMs,
    execute: (args, exec) => safeCall(() => sidecar.runChapter(
      args.project_id,
      args.chapter_number,
      compactObject({
  ...
  ctx.tools.register(defineTool({
    ...
    output: envelopeOutput,
    timeoutMs,
    execute: (args, exec) => safeCall(() => sidecar.resumeRun(
      args.run_id,
      args.force_redraft ?? true,
      exec.signal,
    )),
  ...
  ctx.tools.register(defineTool({
    ...
    timeoutMs,
    isConcurrencySafe: () => true,
    execute: (args, exec) => safeCall(() => sidecar.exportManuscript(
      args.project_id,
  ...
  ctx.tools.register(defineTool({
    ...
    output: envelopeOutput,
    timeoutMs,
    execute: (args, exec) => safeCall(() => sidecar.startAutorun(
      args.project_id,
      args.from_chapter,
      args.to_chapter,
      args.policy,
...
async function safeCall(operation: () => Promise<NovelEnvelope>): Promise<JsonValue> {
  try {
...
function createEnvelopeOutput(maxRenderChars: number) {
  return {
